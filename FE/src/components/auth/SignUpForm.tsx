...
export default function SignUpForm() {
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    if (!isValidAccountEmailInput(trimmedEmail)) {
      setError(getAccountEmailValidationMessage());
      return;
    }
